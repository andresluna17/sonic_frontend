  ...
  $(function() {
    ...
    var e = {
      ...
      errorPlacement: function(e, o) {
        "firstname" == o.attr("name") || "lastname" == o.attr("name")
          ? (e.insertAfter($("#lastname").closest(".row")),
            o.parents("div.form-group").addClass("has-error"))
          : "password" == o.attr("name") || "retype_password" == o.attr("name")
          ? (e.insertAfter($("#retype_password").closest(".row")),
            o.parents("div.form-group").addClass("has-error"))
          : "agree" == o.attr("name")
          ? e.insertAfter("#agree-text")
          : e.insertAfter(o);
      },
      messages: {
    ...
    function e() {
      ...
      var s = $.plot(a, series, {
        grid: {
          ...
          markings: function(e) {
            for (
              var o = [], t = e.xaxis, r = Math.floor(t.min);
              r < t.max;
              r += 2 * t.tickSize
            )
              o.push({ xaxis: { from: r, to: r + t.tickSize }, color: "#fff" });
            return o;
          }
        },
...
var modalMedia = {
  ...
  options: {},
  open: function(e) {
    (e = e || {}), (this.options = e), this.$lo.modal("show");
  },
  close: function() {
